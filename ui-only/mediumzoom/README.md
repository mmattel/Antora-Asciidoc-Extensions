...
This Antora UI extension makes an image zoomable on click. This is very beneficial if you want to enrich your content by including images with a smaller size that do not break the reading flow. If you click on the image, it is show in its original size.
